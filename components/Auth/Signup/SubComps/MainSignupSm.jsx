...
const MainSignupSm = (props) => {
  const { setSignupType, setAuthOptionsView } = props;
  ...
  const phoneSignupHandler = () => {
    setSignupType("phone");
    setAuthOptionsView("signupPhone");
  };
      ...
      <div className="w-full max-w-[400px] flex flex-col items-center justify-end gap-2 px-5 py-[90px]">
        ...
        <Fade direction="up" className="animation-opacity">
          <div className="gap-3 mt-2 w-full  flex flex-col items-center justify-center ">
            {/* Google */}
            <div className="w-full flex justify-start items-center bg-white  px-4 xs:px-6 py-[10px] xs:py-[12px] rounded-md cursor-pointer ">
              {/* --> Google Icon */}
