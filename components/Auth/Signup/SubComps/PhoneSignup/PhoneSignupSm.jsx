...
const PhoneSignupSm = (props) => {
  ...
  const emailSignupHandler = () => {
    setSignupType("email");
    setAuthOptionsView("signupEmail");
  };
  ...
  return (
    <div className="w-[100vw] h-[100vh] flex sm:hidden flex-col items-center justify-between  bg-[url('/images/auth/bg-small.png')] bg-cover bg-no-repeat bg-center">
      {/* Top => Arrow Icon */}
      <div className=" w-full  flex justify-start items-center gap-2 px-5 py-6">
        <div
          onClick={() => setAuthOptionsView("signup")}
              ...
              <div className="w-full flex flex-col items-center justify-center gap-3">
                ...
                <div className="flex items-center justify-center flex-col w-full gap-1">
                  <p className=" text-black text-center font-josefin font-normal italic text-[13px] md:text-sm">
                    ...
                    <Link href="/" onClick={signinViewHandler}>
                      <span className="font-bold text-darkBrown">Sign In</span>
                    </Link>
                  </p>
                  {/* Sign Up Buton */}
